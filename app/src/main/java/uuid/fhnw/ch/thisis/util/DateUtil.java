...
public class DateUtil {
    ...
    public static String getFormattedDate(Date lastMessageDate) {

        if(lastMessageDate == null) {
            return "";
        } else if (isToday(lastMessageDate)) {
            return new SimpleDateFormat("HH:mm").format(lastMessageDate);
        } else if(isYesterday(lastMessageDate)) {
            return "yesterday";
        } else {
            return new SimpleDateFormat("dd.MM.yyyy").format(lastMessageDate);
        }
    }
     ...
     *
     * @param date
     * @return true if {@code date} was yesterday
     */
